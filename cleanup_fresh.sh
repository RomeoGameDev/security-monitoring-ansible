...
echo "UWAGA: skrypt usuwa dane kontenerów Wazuh, Zabbix i Nginx Proxy Manager."
echo "Docker oraz pakiet Zabbix Agent 2 na hoście pozostają zainstalowane."
...
docker volume ls --format '{{.Name}}' \
  | grep -E '^(single-node_|npm_|zabbix_)' \
